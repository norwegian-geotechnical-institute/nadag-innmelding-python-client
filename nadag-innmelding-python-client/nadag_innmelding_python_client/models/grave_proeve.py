...
T = TypeVar("T", bound="GraveProeve")


@_attrs_define
class GraveProeve:
    """omrørt fysisk prøvemateriale manuelt gravd ut fra sjakt eller grøft <engelsk>disturbed physical soil sample manually
    digged from a ditch or pit</engelsk>

        Attributes:
            json_type (Union[Literal['GraveProeve'], Unset]):
    ...
    json_type: Union[Literal["GraveProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["GraveProeve"], Unset], d.pop("jsonType", UNSET))
        if json_type != "GraveProeve" and not isinstance(json_type, Unset):
            raise ValueError(f"jsonType must match const 'GraveProeve', got '{json_type}'")
        ...
        grave_proeve.additional_properties = d
        return grave_proeve
