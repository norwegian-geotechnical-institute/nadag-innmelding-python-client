...
T = TypeVar("T", bound="SkovlProeve")


@_attrs_define
class SkovlProeve:
    """geoteknisk prøvetaking for opptak av omrørte prøver <engelsk>geotechnical sampling where disturbed samples are
    colleced</engelsk>

        Attributes:
            json_type (Union[Literal['SkovlProeve'], Unset]):
    ...
    json_type: Union[Literal["SkovlProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["SkovlProeve"], Unset], d.pop("jsonType", UNSET))
        if json_type != "SkovlProeve" and not isinstance(json_type, Unset):
            raise ValueError(f"jsonType must match const 'SkovlProeve', got '{json_type}'")
        ...
        skovl_proeve.additional_properties = d
        return skovl_proeve
