...
T = TypeVar("T", bound="SedimentProeve")


@_attrs_define
class SedimentProeve:
    """sedimentprøve<engelsk>sediment sample</engelsk>

    Attributes:
        json_type (Union[Literal['SedimentProeve'], Unset]):
    ...
    json_type: Union[Literal["SedimentProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["SedimentProeve"], Unset], d.pop("jsonType", UNSET))
        ...
        sediment_proeve.additional_properties = d
        return sediment_proeve
