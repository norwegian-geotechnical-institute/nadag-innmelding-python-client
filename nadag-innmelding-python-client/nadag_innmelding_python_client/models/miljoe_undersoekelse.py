...
T = TypeVar("T", bound="MiljoeUndersoekelse")


@_attrs_define
class MiljoeUndersoekelse:
    """miljøundersøkelse<engelsk>environmental investigation</engelsk>

    Attributes:
        json_type (Union[Literal['MiljoeUndersoekelse'], Unset]):
    ...
    json_type: Union[Literal["MiljoeUndersoekelse"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["MiljoeUndersoekelse"], Unset], d.pop("jsonType", UNSET))
        if json_type != "MiljoeUndersoekelse" and not isinstance(json_type, Unset):
            raise ValueError(f"jsonType must match const 'MiljoeUndersoekelse', got '{json_type}'")
        ...
        miljoe_undersoekelse.additional_properties = d
        return miljoe_undersoekelse
