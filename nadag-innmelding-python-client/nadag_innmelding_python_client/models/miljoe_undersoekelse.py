...
class MiljoeUndersoekelse:
    ...
    Attributes:
        ...
        json_type (Literal['MiljoeUndersoekelse'] | Unset):
    ...
    json_type: Literal["MiljoeUndersoekelse"] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        json_type = cast(Literal["MiljoeUndersoekelse"] | Unset, d.pop("jsonType", UNSET))
