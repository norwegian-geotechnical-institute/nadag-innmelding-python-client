...
T = TypeVar("T", bound="BlokkProeve")


@_attrs_define
class BlokkProeve:
    """fysisk prøvemateriale manuelt skjært ut fra bunnen av en utgravning eller ved hjelp av spesialutviklet
    prøvetakingsutstyr

    <engelsk>physical sample manually cut from the bottom of a ditch or with special sample equipment</engelsk>

        Attributes:
            json_type (Union[Literal['BlokkProeve'], Unset]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["BlokkProeve"], Unset], d.pop("jsonType", UNSET))
        ...
        blokk_proeve.additional_properties = d
        return blokk_proeve
