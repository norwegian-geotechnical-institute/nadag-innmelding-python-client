...
class GassProeve:
    ...
    Attributes:
        json_type (Union[Literal['GassProeve'], Unset]):
    ...
    json_type: Union[Literal["GassProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["GassProeve"], Unset], d.pop("jsonType", UNSET))
        if json_type != "GassProeve" and not isinstance(json_type, Unset):
            raise ValueError(f"jsonType must match const 'GassProeve', got '{json_type}'")
        ...
        gass_proeve.additional_properties = d
        return gass_proeve
