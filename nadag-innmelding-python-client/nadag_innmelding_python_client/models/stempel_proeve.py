...
class StempelProeve:
    ...
    until the desired depth</engelsk>
        ...
        Attributes:
            json_type (Union[Literal['StempelProeve'], Unset]):
    ...
    json_type: Union[Literal["StempelProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["StempelProeve"], Unset], d.pop("jsonType", UNSET))
