...
T = TypeVar("T", bound="KanneProeve")


@_attrs_define
class KanneProeve:
    """omrørt fysisk prøvemateriale tatt i organiske materialer eller bløte leirer med enkelt håndoperert utstyr

    <engelsk>disturbed physical soil sample taken from organic material or soft clays with simple hand operated
    equipment</engelsk>

        Attributes:
            json_type (Union[Literal['KanneProeve'], Unset]):
    ...
    json_type: Union[Literal["KanneProeve"], Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        json_type = cast(Union[Literal["KanneProeve"], Unset], d.pop("jsonType", UNSET))
        if json_type != "KanneProeve" and not isinstance(json_type, Unset):
            raise ValueError(f"jsonType must match const 'KanneProeve', got '{json_type}'")
        ...
        kanne_proeve.additional_properties = d
        return kanne_proeve
