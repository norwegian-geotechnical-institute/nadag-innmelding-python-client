...
from ..models.vann_proeve_kilde import VannProeveKilde
...
class VannProeve:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if vann_pr_ø_ve_type is not UNSET:
            field_dict["vannPrøveType"] = vann_pr_ø_ve_type
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_vann_pr_ø_ve_type, Unset):
            ...
            vann_pr_ø_ve_type = VannProeveKilde(_vann_pr_ø_ve_type)
        ...
        vann_proeve = cls(
            ...
            vann_pr_ø_ve_type=vann_pr_ø_ve_type,
        )

        vann_proeve.additional_properties = d
        return vann_proeve
